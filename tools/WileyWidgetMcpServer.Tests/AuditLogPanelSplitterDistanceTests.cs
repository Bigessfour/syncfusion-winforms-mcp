...
public class AuditLogPanelSplitterDistanceTests
{
    [Fact]
    public async Task AuditLogPanel_SplitterDistance_WithinBounds()
    {
        var csxPath = Path.Combine(AppContext.BaseDirectory, "AuditLogPanel.SplitterDistance.csx");
